              ...
              <form action='' method="POST">
               <div class='form-group' style="">
                    ...
                    <select name='id_seminar' class='form-control ' >
	                   <?php 
	                   $shift = mysql_query("SELECT seminar.id_seminar AS id ,seminar.tema AS tema FROM seminar,user WHERE seminar.id_fakultas = user.id_fakultas AND user.id_fakultas = '3'");
