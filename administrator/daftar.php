 ...
 <div class="col-md-12"><h2>Umum</h2></div>
 	<form action="" method="post">
 		<div class= "form-group">
 			...
 			<select name="seminar" class="form-control">
 				...
 				while ($hseminar=mysql_fetch_array($seminar)) {
 					?>
 						<option value="<?php echo $hseminar['id_seminar'] ?>"><?php echo $hseminar['tema'];  ?></option>
 		...
 		<div class= "form-group">
 			...
 			<input type="number" required name="no_identitas" class="form-control"  placeholder="Nomer Identitas"/>	
 		</div>
 		<div class= "form-group">
 			<label>Nama</label>
 		...
 		<div class= "form-group">
 			<label>Telepon</label>
 			<input type="number" required name="kontak" class="form-control"  placeholder="Ho hp"/>	
 		</div>
 		<div class= "form-group">
 			<label>Email</label>
 			<input type="email" required name="email" class="form-control"  placeholder="Alamt Email"/>	
 		</div>
 		<div class= "form-group">
 			<label>Jk</label>
